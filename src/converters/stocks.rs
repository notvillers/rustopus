...
pub async fn get_data(url: &str, xmlns: &str, authcode: &str, web_update: &DateTime<Utc>) -> String {
    let hu_stocks_xml = get_xml(url, xmlns, authcode, web_update).await;
    match get_envelope(&hu_stocks_xml) {
...
/// # Parameters
/// * hu_envelope: `o8_xml::stocks::Envelope`
/// # Returns
/// `String`
fn convert_envelope_to_xml(hu_envelope: o8_xml::stocks::Envelope) -> String {
